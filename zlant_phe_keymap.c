...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LSFT, KC_LALT, KC_LGUI, KC_LSFT, MO(_AL), KC_SPC,  KC_SPC,  MO(_FL), KC_LBRC, KC_RBRC, KC_BSLS, KC_RSFT
  ),
    ...
    [_FL] = LAYOUT(
        ...
        KC_CAPS, KC_4   , KC_6   , KC_7   , _______, _______, KC_LEFT, KC_UP  , KC_DOWN, KC_RIGHT, _______, KC_TRNS,
